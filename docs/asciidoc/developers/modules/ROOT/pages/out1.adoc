...
* https://opensmarthouse.org/zwavedatabase/2/reference/Devolo-home-Control-Door-Window.pdf[Device Manual]

---

Did you spot an error in the above definition or want to improve the content?
You can https://opensmarthouse.org/zwavedatabase/2[contribute to the database here]
